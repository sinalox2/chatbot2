...
def agregar_contacto_proactivo():
    ...
    try:
        ...
        # Modificar observaciones para incluir información del contacto y template
        info_adicional = []
        if primer_contacto:
        ...
        # IMPORTANTE: Agregar template a observaciones siempre que exista
        if template_whatsapp:
            info_adicional.append(f"Template: {template_whatsapp}")
        ...
        # Usar template tanto para primer contacto como para cualquier contacto que lo tenga
        template_final = template_whatsapp if template_whatsapp else None
